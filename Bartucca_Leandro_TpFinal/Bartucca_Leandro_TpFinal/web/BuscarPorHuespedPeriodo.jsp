...
<html lang="es">
    <head>
        <title>Reservas por huesped y periodo</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5">
                        <h2 class="heading-section">Ver las reservas por huesped y periodo</h2>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr class="bg-dark">
                                        ...
                                        <% Controladora control = (Controladora) miSesion.getAttribute("control");
                                            ...
                                            String nombre_hue = (String) miSesion.getAttribute("nombre_hue");
                                            String apellido_hue = (String) miSesion.getAttribute("apellido_hue");
                                            ...
                                            List<Reserva> listaReservas = control.getReservasPorHuespedPeriodo(nombre_hue, apellido_hue, fecha_desde, fecha_hasta);
