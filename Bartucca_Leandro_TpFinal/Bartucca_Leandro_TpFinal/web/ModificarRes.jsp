...
<html lang="es">
    ...
    <body>
        ...
        <div class="contact main-font-family text-center">
            <div class="container">
                <h2 id="contact">Modificar Reserva</h2>
                <div class="row">
                    <div class="col-6">
                        <div class="contact-form">

                            <%  HttpSession miSesionMEmp = request.getSession();
                                //Traigo la reserva en concreto segun la busqueda
                                Reserva res = (Reserva) miSesionMEmp.getAttribute("reserva");

                            %>

                            <form action="SvModificarRes" method="get">
                                ...
                                <input type="hidden" name="id_res" value="<%= res.getId_reserva()%>">
