            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-6 text-center mb-5">
                        <h2 class="heading-section">Ver las reservas por fecha de carga</h2>
                    </div>
                </div>
                                ...
                                <tbody>
                                    <tr class="bg-dark">
                                        ...
                                        <% Controladora control = (Controladora) miSesion.getAttribute("control");
                                            Date fecha_carga = (Date) miSesion.getAttribute("fecha_carga");

                                            SimpleDateFormat formatoFecha = new SimpleDateFormat("yyyy-MM-dd");

                                            //Traigo mi nueva lista segun la busqueda
                                            List<Reserva> listaReservas = control.getReservasPorFecha(fecha_carga);
